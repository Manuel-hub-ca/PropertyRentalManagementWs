...
namespace PropertyRentalManagementWs.Controllers
{
    public class AdministratorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Password,Email")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Password,Email")] Administrator administrator)
        {
